...
def get_user_random_drink(user_id):
    ...
    reviews = Review.query.filter_by(drinkname=drink['strDrink']).all()
    if reviews:
        return render_template('user_random_drink.html', drink=drink, drink_details=drink_details, reviews=reviews, user=user)
    else:
        return render_template('user_random_drink.html', drink=drink, drink_details=drink_details, user=user)
    # return render_template('random_drink.html', drink=drink, drink_details=drink_details)
